...
@Component({
    moduleId: module.id,
    selector: 'raskod-izmerirel-template-component',
    templateUrl: 'raskod-izmerirel-template-component.html',
    styleUrls: ['raskod-izmerirel-template-component.css']
})


export class RaskodIzmerirelTemplateComponent implements OnInit{      
