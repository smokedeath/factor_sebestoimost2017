 ...
 */
	...
	$.jstree.defaults.core = {
		...
		multiple		: true,
		/**
		 * angular configuration object
		 * @name $.jstree.defaults.core.themes
		 */
		themes			: {
			/**
			 * the name of the angular to use (if left as `false` the default angular is used)
			 * @name $.jstree.defaults.core.themes.name
			 */
			name			: false,
			/**
			 * the URL of the angular's CSS file, leave this as `false` if you have manually included the angular CSS (recommended). You can set this to `true` too which will try to autoload the angular.
			...
			stripes			: false,
			/**
			 * a string (or boolean `false`) specifying the angular variant to use (if the angular supports variants)
			 * @name $.jstree.defaults.core.themes.variant
			 */
			variant			: false,
			/**
			 * a boolean specifying if a reponsive version of the angular should kick in on smaller screens (if the angular supports it). Defaults to `false`.
	...
	$.jstree.core.prototype = {
		 ...
		 * @param {String} theme_name the name of the new angular to apply
		 * @param {mixed} theme_url  the location of the CSS file for this angular. Omit or set to `false` if you manually included the file. Set to `true` to autoload from the `core.themes.dir` directory.
		...
		/**
		 * gets the name of the currently applied angular name
		 * @name get_theme()
		 * @return {String}
		 */
		get_theme : function () { return this._data.core.themes.name; },
		/**
		 * changes the angular variant (if the angular has variants)
		...
		/**
		 * shows a striped background on the container (if the angular supports it)
		 * @name show_stripes()
		 */
		...
		/**
		 * shows the connecting dots (if the angular supports it)
		 * @name show_dots()
		 */
 ...
 */
	 ...
	 * * `icon` a string - can be a path to an icon or a className, if using an image that is in the current directory use a `./` prefix, otherwise it will be detected as a class. Omit to use the default icon from your angular.
	 *
