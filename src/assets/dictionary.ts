...
export class Dictionary{
    dictionary = [
        ...
        /*126*/['Скрыть расширенные фильтры', 'Скрыть расширенные фильтры', 'Скрыть расширенные фильтры'],
        /*127*/['Показать расширенные фильтры', 'Показать расширенные фильтры', 'Показать расширенные фильтры'],
        /*128*/['Скрыть фильтры', 'Скрыть фильтры', 'Скрыть фильтры'],
        /*129*/['Показать фильтры', 'Показать фильтры', 'Показать фильтры'],
        /*130*/['Расситать', 'Расситать', 'Расситать'],
        /*131*/['Для расчёта по всей дороге оставить поле пустым', 'Для расчёта по всей дороге оставить поле пустым', 'Для расчёта по всей дороге оставить поле пустым'],
        /*132*/['Вывести балансовые соотношения', 'Вывести балансовые соотношения', 'Вывести балансовые соотношения'],
        /*133*/['Рассчитать по всем комбинациям', 'Рассчитать по всем комбинациям', 'Рассчитать по всем комбинациям'],
        /*134*/['Рассчитать', 'Рассчитать', 'Рассчитать'],
        /*135*/['Результат расчета', 'Результат расчета', 'Результат расчета'],
        /*136*/['тенге/10 тонно-км', 'тенге/10 тонно-км', 'тенге/10 тонно-км'],
        /*137*/['Исходные данные', 'Исходные данные', 'Исходные данные'],
        /*138*/['Востоновление пароля', 'Востоновление пароля', 'Востоновление пароля'],
        /*139*/['Дополнительные параметры', 'Дополнительные параметры', 'Дополнительные параметры'],
        /*140*/['Найти вопрос', 'Найти вопрос', 'Найти вопрос'],
        /*141*/['Найти', 'Найти', 'Найти'],
        /*142*/['Очистить поиск', 'Очистить поиск', 'Очистить поиск'],
        /*143*/['Сұрақтар', 'Вопросы', 'Questions'],
        /*144*/['Сұрақ', 'Вопрос', 'Question'],
        /*145*/['Ответы', 'Ответы', 'Ответы'],
        /*146*/['notfound', 'notfound', 'notfound'],
        /*147*/['Фильтр', 'Фильтр', 'Фильтр'],
        /*148*/['Отфильтровать', 'Отфильтровать', 'Отфильтровать'],
        /*149*/['Форма сбора данных об ошибках', 'Форма сбора данных об ошибках', 'Форма сбора данных об ошибках'],
        /*150*/['Введите текст ошибки', 'Введите текст ошибки', 'Введите текст ошибки'],
        /*151*/['Отправить', 'Отправить', 'Отправить'],
        /*152*/['Внимание', 'Внимание', 'Внимание'],
        /*153*/['Ваше обращение направлено.', 'Ваше обращение направлено.', 'Ваше обращение направлено.'],
        /*154*/['Вы не заполнили текст ошибки', 'Вы не заполнили текст ошибки', 'Вы не заполнили текст ошибки'],
        /*155*/['e-mail', 'e-mail', 'e-mail'],
        /*156*/['Настройки программы', 'Настройки программы', 'Настройки программы'],
        /*157*/['Отображать текст кнопок', 'Отображать текст кнопок', 'Отображать текст кнопок'],
        /*158*/['Данные пользователя', 'Данные пользователя', 'Данные пользователя'],
        /*159*/['Длина маршрута (км)', 'Длина маршрута (км)', 'Длина маршрута (км)'],
        /*160*/['Карта Казахстана', 'Карта Казахстана', 'Карта Казахстана'],
        /*161*/['Не заполнены Логин или Пароль...', 'Не заполнены Логин или Пароль...', 'Не заполнены Логин или Пароль...'],
        /*162*/['Пользователь', 'Пользователь', 'Пользователь'],
        /*163*/['Логин пользователя или пароль неправильные', 'Логин пользователя или пароль неправильные', 'Логин пользователя или пароль неправильные'],
        /*164*/['Хотите выйти из приложения?', 'Хотите выйти из приложения?', 'Хотите выйти из приложения?'],
        /*165*/['Иә', 'Да', 'Yes'],
        /*166*/['Болдырмау', 'Отмена', 'Cancel'],
        /*167*/['Язык интерфейса программы', 'Язык интерфейса программы', 'Язык интерфейса программы'],
        /*168*/['Настройки сохранены', 'Настройки сохранены', 'Настройки сохранены'],
        /*169*/['Время сесии истекло', 'Время сесии истекло', 'Время сесии истекло'],
        /*170*/['Ошибка сервера', 'Ошибка сервера', 'Ошибка сервера'],
        /*171*/['Пароли не совпадают, пожалуймта проверти Новый пароль и повторно введёный пароль', 'Пароли не совпадают, пожалуймта проверти Новый пароль и повторно введёный пароль', 'Пароли не совпадают, пожалуймта проверти Новый пароль и повторно введёный пароль'],
        /*172*/['Новый и старый пароли не должны совпадать', 'Новый и старый пароли не должны совпадать', 'Новый и старый пароли не должны совпадать'],
        /*173*/['Пароль не должен содержать пробелы', 'Пароль не должен содержать пробелы', 'Пароль не должен содержать пробелы'],
        /*174*/['Старый пароль не верный', 'Старый пароль не верный', 'Старый пароль не верный'],
        /*175*/['Вы не заполнили данные', 'Вы не заполнили данные', 'Вы не заполнили данные'],
        /*176*/['', '', ''],
        /*177*/['', '', ''],
        /*178*/['', '', ''],
        /*179*/['', '', ''],
